...
try {
    ...
    $getMaxId = $pdo->query("SELECT COALESCE(MAX(id), 0) + 1 as next_id FROM notifications");
    $nextId = $getMaxId->fetch(PDO::FETCH_ASSOC)['next_id'];
    ...
    $success = $stmt->execute([$nextId, $user_id, $message]);
